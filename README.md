...
![Bitbucket open pull requests](https://img.shields.io/bitbucket/pr-raw/gbrasil720/helper-js?style=for-the-badge)

> helper-js is a simple node.js package that promise help in your daily coding experience, provides you some "plug-in-play" functions, that you can just import and use everywhere
...
## 🚀 Installing helper-js

To install helper-js, just follow this steps:
...
To use helper-js functions, just follow this steps:

```ts
import { Method } from 'helper-js' // change "Method" to a real lib method
